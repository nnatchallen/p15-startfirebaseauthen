<template>
    <div class="login">
      <h3>Sign in</h3>
      <input type="text" v-model="user.username" placeholder="Email Address"><br>
      <input type="password" v-model="user.password" placeholder="Password"><br>
      <button @click="login">Login</button>
      <p>You don't have an account? You can <router-link to="/signin"> create account here</router-link><br>
      <hr>
      <p>Sign-in with <a @click="loginGoogle">Google</a> or <a @click="loginFacebook">Facebook</a> account.</p>
